        ...
        <div class="container">
            ...
            <div class="col-lg-9 g-mb-50 g-mb-0--lg">
                ...
                <div class="row g-mb-30">
                  ...
                  <div class="col-md-5">
                    <figure class="u-shadow-v25 g-pos-rel g-mb-20 g-mb-0--lg">
                      <img class="img-fluid w-100" src="<?php echo get_template_directory_uri();?>/img-temp/400x270/img3.jpg" alt="Image Description">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 g-mb-30">
                  <article>
                    <figure class="u-shadow-v25 g-pos-rel">
                      <div class="embed-responsive embed-responsive-16by9 g-mb-30">
                          <iframe src="(<?php bloginfo('template_directory'); ?>/https://www.youtube.com/watch?v=jP9T4s5--eU" width="400" height="300" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
                      </div>
                    </figure>

                    <h3 class="g-font-size-14 g-mb-10">
                ...
                <div class="col-lg-4 col-sm-6 g-mb-30">
                  <article>
                    <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                      <img class="img-fluid w-100" src="<?php echo get_template_directory_uri();?>/img-temp/400x270/img6.jpg" alt="Image Description">
                ...
                <div class="col-lg-4 col-sm-6 g-mb-30">
                  <article>
                    <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                      <img class="img-fluid w-100" src="<?php echo get_template_directory_uri();?>/img-temp/400x270/img7.jpg" alt="Image Description">
                ...
                <div class="col-lg-4 col-sm-6 g-mb-30 g-mb-0--sm">
                  <article>
                    <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                      <img class="img-fluid w-100" src="<?php echo get_template_directory_uri();?>/img-temp/400x270/img9.jpg" alt="Image Description">
                ...
                <div class="col-lg-4 col-sm-6 g-mb-30 g-mb-0--sm">
                  <article>
                    <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                      <img class="img-fluid w-100" src="<?php echo get_template_directory_uri();?>/img-temp/400x270/img8.jpg" alt="Image Description">
                ...
                <div class="col-lg-4 col-sm-6">
                  <article>
                    <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                      <img class="img-fluid w-100" src="<?php echo get_template_directory_uri();?>/img-temp/400x270/img10.jpg" alt="Image Description">
              ...
              <div class="g-mb-30">
                ...
                <article class="media g-mb-30">
                  <a class="d-flex u-shadow-v25 mr-3" href="#!">
                    <img class="g-width-60 g-height-60" src="<?php echo get_template_directory_uri();?>/img-temp/100x100/img4.jpg" alt="Image Description">
                  </a>
                ...
                <article class="media g-mb-30">
                  <a class="d-flex u-shadow-v25 mr-3" href="#!">
                    <img class="g-width-60 g-height-60" src="<?php echo get_template_directory_uri();?>/img-temp/100x100/img5.jpg" alt="Image Description">
                  </a>
          ...
          <div class="row no-gutters g-mb-60">
            <div class="col-lg-4 g-pr-2--lg g-mb-30 g-mb-0--lg">
              ...
              <article class="u-block-hover">
                <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                  <img class="u-block-hover__main--zoom-v1 img-fluid" src="<?php echo get_template_directory_uri();?>/img-temp/500x450/img5.jpg" alt="Image Description">
                </figure>
            ...
            <div class="col-lg-4 g-px-1--lg g-mb-30 g-mb-0--lg">
              ...
              <article class="u-block-hover">
                <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                  <img class="u-block-hover__main--zoom-v1 img-fluid" src="<?php echo get_template_directory_uri();?>/img-temp/500x450/img6.jpg" alt="Image Description">
                </figure>
                <div class="w-100 text-center g-absolute-centered g-px-20">
            ...
            <div class="col-lg-4 g-pl-2--lg">
              ...
              <article class="u-block-hover">
                <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                  <img class="u-block-hover__main--zoom-v1 img-fluid" src="<?php echo get_template_directory_uri();?>/img-temp/500x450/img7.jpg" alt="Image Description">
                </figure>
                <div class="w-100 text-center g-absolute-centered g-px-20">
                ...
                <div class="row">
                  <div class="col-lg-6 g-mb-50 g-mb-0--lg">
                    ...
                    <article class="g-mb-40">
                      <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                        <img class="img-fluid w-100" src="<?php echo get_template_directory_uri();?>/img-temp/400x270/img11.jpg" alt="Image Description">
                    ...
                    <article class="media">
                      <figure class="d-flex u-shadow-v25 mr-3 g-pos-rel">
                        <img class="g-width-140 g-height-80" src="<?php echo get_template_directory_uri();?>/img-temp/200x115/img1.jpg" alt="Image Description">
