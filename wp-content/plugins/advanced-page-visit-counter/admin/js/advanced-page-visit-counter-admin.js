(function( $ ) {
	...
	jQuery(document).on('click',".submit_config",function(e){
		...
		var show_today_count = jQuery("#apv_show_today_count").prop('checked');
		var show_global_count = jQuery("#apv_show_global_count").prop('checked');
		var widget_width = jQuery("#apv_widget_widget").val();

		jQuery.ajax({
	       type : "post",
	       url : apv_ajax.ajax_url,
	       data : { action: "save_avc_config", widget_width:widget_width,show_global_count:show_global_count,show_today_count:show_today_count,wid_alignment:wid_alignment,exclude_show_counter:exclude_show_counter,exclude_counts:exclude_counts,apv_default_border_width:apv_default_border_width,apv_default_border_radius:apv_default_border_radius,apv_default_background_color:apv_default_background_color,apv_default_label:apv_default_label,apv_default_border_color:apv_default_border_color,postTypes:postTypes,ipAddresses:ipAddresses,spamCheck:spamCheck,excludeUser:excludeUser,showCounter:showCounter,counterColor:counterColor },
	       success: function(response) {
	...
	jQuery(document).on("click","#genButton",function( e ){
		...
		if( shType == 'individual' && shArticle == '' ){
			...
			jQuery.ajax({
		       type : "post",
		       url : apv_ajax.ajax_url,
		       data : { action: "generate_shortcode", show_global_count:show_global_count,show_today_count:show_today_count,shType:shType,shArticle:shArticle,width:width,padding:padding,counter_label:counter_label,border_color:border_color,border_style:border_style,border_size:border_size,border_radius:border_radius,bg_color:bg_color,font_size:font_size,font_style:font_style,font_color:font_color },
		       success: function(response) {
					jQuery(".progress").hide();
